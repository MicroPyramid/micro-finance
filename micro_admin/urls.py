...
urlpatterns = patterns('micro_admin.views',
    ...
    url(r'^viewgroupsavingsdeposits/(?P<savingsaccount_id>\d+)/$','view_groupsavings_deposits',name='viewgroupsavingsdeposits'),
    url(r'^viewgroupsavingswithdrawals/(?P<savingsaccount_id>\d+)/$','view_groupsavings_withdrawals',name='viewgroupsavingswithdrawals'),
    ...
    url(r'^listofclientloandeposits/(?P<loanaccount_id>\d+)/$', 'listofclient_loan_deposits', name='listofclientloandeposits'),
    url(r'^listofclientsavingsdeposits/(?P<savingsaccount_id>\d+)/$', 'listofclient_savings_deposits', name='listofclientsavingsdeposits'),
    url(r'^listofclientsavingswithdrawals/(?P<savingsaccount_id>\d+)/$', 'listofclient_savings_withdrawals', name='listofclientsavingswithdrawals'),
    url(r'^grouploantransactions/(?P<loanaccount_id>\d+)/$','group_loan_transactions',name='grouploantransactions'),
    url(r'^viewgrouploandeposits/(?P<loanaccount_id>\d+)/$','view_grouploan_deposits',name='viewgrouploandeposits'),
    url(r'^issuegrouploan/(?P<loanaccount_id>\d+)/$','issue_group_loan',name='issuegrouploan'),

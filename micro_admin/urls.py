...
urlpatterns = [
    ...
    url(r'^group/create/$',
        ...
        name='creategroup'),
    url(r'^group/(?P<group_id>\d+)/profile/$',
    ...
    url(r'^generalledger/$',
        ...
        name="generalledger"),
    url(r'^fixeddeposits/$',
        FixedDepositsView.as_view(),
        name="fixeddeposits"),
    url(r'^clientfixeddepositsprofile/(?P<fixed_deposit_id>\d+)/$',
        ClientFixedDepositsProfile.as_view(),
        name="clientfixeddepositsprofile"),
    url(r'^viewclientfixeddeposits/$',
        ViewClientFixedDeposits.as_view(),

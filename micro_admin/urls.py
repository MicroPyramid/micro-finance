...
urlpatterns = [
    ...
    url(r'^grouploanaccountslist/(?P<group_id>\d+)/$', view_group_loanslist, name="grouploanaccountslist"),
    url(r'^clientloanaccountslist/(?P<client_id>\d+)/$', view_client_loanslist, name="clientloanaccountslist"),

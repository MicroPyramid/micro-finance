...
urlpatterns = patterns('micro_admin.views',
    ...
    url(r'^listofclientloandeposits/(?P<client_id>\d+)/$', 'listofclient_loan_deposits', name='listofclientloandeposits'),
    ...
    url(r'^viewgrouploandeposits/(?P<group_id>\d+)/$','view_grouploan_deposits',name='viewgrouploandeposits'),
    ...
    url(r'^ledgeraccount/(?P<client_id>\d+)/$', 'ledger_account', name="ledgeraccount"),

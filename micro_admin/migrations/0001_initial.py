...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('transaction_type', models.CharField(max_length=20, choices=[(b'Deposit', b'Deposit'), (b'Withdraw', b'Withdraw')])),
                ('transaction_date', models.DateTimeField(auto_now_add=True)),
                ('transaction_amount', models.DecimalField(max_digits=19, decimal_places=6)),
                ('savings_account', models.ForeignKey(to='micro_admin.SavingsAccount')),
                ('staff', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },

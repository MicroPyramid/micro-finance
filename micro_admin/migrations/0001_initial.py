    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principle_loan_balance_atinstant', models.DecimalField(null=True, max_digits=19, decimal_places=6, blank=True)),
                ('principle_loanamount_repaid_atinstant', models.DecimalField(null=True, max_digits=19, decimal_places=6, blank=True)),
                ('interest_repaid_atinstant', models.DecimalField(null=True, max_digits=19, decimal_places=6, blank=True)),
